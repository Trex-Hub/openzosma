...
const Iphone = ({ src, videoSrc, children, className, style, ...props }: IphoneProps) => {
	...
	return (
		...
		>
			{hasChildren && (
				<div className="absolute z-50 overflow-hidden pt-12 xs:pt-16 sm:pt-20 lg:pt-24" style={screenStyle}>
					{children}
				</div>
			)}
