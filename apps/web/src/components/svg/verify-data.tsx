		...
		>
			...
			<g transform="translate(-484.076 -211)">
				...
				<g transform="translate(997.226 362.625)">
					<rect width="21.243" height="27.999" transform="translate(49.912 543.263)" fill="#ed9da0" />
					<path
						...
						fill="#090814"
					/>
					<rect width="21.243" height="27.999" transform="translate(190.867 536.429) rotate(-16.22)" fill="#ed9da0" />
					<path
				...
				<path
					...
					fill="#3f3d56"
				/>
				<circle cx="33.349" cy="33.349" r="33.349" transform="translate(963.599 211)" fill="currentColor" />
				<path
				...
				<g transform="translate(524.682 567.162)">
					...
					<g transform="translate(0 59.139)">
						<circle cx="33.349" cy="33.349" r="33.349" transform="translate(0)" fill="currentColor" />
						<path
